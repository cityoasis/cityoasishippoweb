...
@HippoEssentialsGenerated(internalName = "hippoweb:video")
@Node(jcrType = "hippoweb:video")
public class Video extends BaseDocument {
    ...
    @HippoEssentialsGenerated(internalName = "hippoweb:description")
    public String getDescription() {
        return getProperty("hippoweb:description");
    }

    @HippoEssentialsGenerated(internalName = "hippoweb:link")
    public String getLink() {
        return getProperty("hippoweb:link");
    }
}
