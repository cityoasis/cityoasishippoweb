...
@Node(jcrType = "hippoweb:author")
public class Author extends HippoDocument implements AuthorEntry {

    public static final String ROLE = "hippoweb:role";
    public static final String ACCOUNTS = "hippoweb:accounts";
    public static final String FULL_NAME = "hippoweb:fullname";
    public static final String IMAGE = "hippoweb:image";
    public static final String CONTENT = "hippoweb:content";

    @HippoEssentialsGenerated(internalName = "hippoweb:fullname")
    ...
    @HippoEssentialsGenerated(internalName = "hippoweb:role")
    ...
    public HippoGalleryImage getImage() {
  	...
  	@HippoEssentialsGenerated(internalName = "hippoweb:accounts")
