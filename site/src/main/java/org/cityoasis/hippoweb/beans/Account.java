...
@HippoEssentialsGenerated(internalName = "hippoweb:account")
@Node(jcrType = "hippoweb:account")
public class Account extends HippoCompound {

    public static final String TYPE = "hippoweb:type";
    public static final String LINK = "hippoweb:link";

    @HippoEssentialsGenerated(internalName = "hippoweb:type")
