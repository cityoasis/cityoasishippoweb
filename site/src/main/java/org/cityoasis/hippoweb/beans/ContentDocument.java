...
@HippoEssentialsGenerated(internalName = "hippoweb:contentdocument")
@Node(jcrType = "hippoweb:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "hippoweb:introduction")
    public String getIntroduction() {
        return getProperty("hippoweb:introduction");
    }
    ...
    public Calendar getPublicationDate() {
        return getProperty("hippoweb:publicationdate");
    }
}
